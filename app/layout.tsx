...
export const metadata: Metadata = {
  ...
  description: 'Portfolio of Sahaji Perera - Full-Stack Developer specializing in AI-powered solutions, web development, and distributed systems. Seeking Data Analyst internship.',
